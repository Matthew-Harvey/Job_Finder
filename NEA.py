...
def display(job_name):
    ...
    jobdes = tk.Button(result_tab, text="DESCRIPTION", command = lambda: [displaydescript(descript, job_name), closetab(result_tab)]).grid(row=2, column=1)
...
def displaydescript(descript, job_name):
    ...
    backbutton = tk.Button(result_tab, text="Back", command = lambda: [closetab(result_tab), display(job_name)]).grid(row=20, column=1)
